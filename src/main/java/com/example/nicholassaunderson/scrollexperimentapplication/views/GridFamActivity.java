...
public class GridFamActivity extends AppCompatActivity {
    /*
    ...
    protected void onCreate(Bundle savedInstanceState) {
        final Intent intent = new Intent(GridFamActivity.this, MainActivity.class);;

        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_grid_fam);
        ...
        for(int i=0; i<48; i++) {
            ...
            button.setId(i + 1);
            button.setBackgroundResource(getApplicationContext().getResources().getIdentifier("f_"+String.valueOf(i+1),
            ...
            button.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    /*
                    Once all the isons have been found an intent is executued to direct back to the
                    home screen.
                     */
                    if(counter>4){
        ...
        //The button list is shuffle once upon start up
        shuffleButtons(buttonList);
